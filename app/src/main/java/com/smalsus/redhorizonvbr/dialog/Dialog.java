package com.smalsus.redhorizonvbr.dialog;
...
public class Dialog {
    ...
    public static AlertDialog createConnectDialog(EditText participantEditText,
        ...
        alertDialogBuilder.setIcon(R.drawable.ic_video_white_24dp);
    ...
    private static void setRoomNameFieldInDialog(EditText roomNameEditText,
        ...
        int horizontalPadding = context.getResources().getDimensionPixelOffset(R.dimen.fab_margin);
        int verticalPadding = context.getResources().getDimensionPixelOffset(R.dimen.fab_margin);
